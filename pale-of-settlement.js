var paleofsettlement_baseoverlay = null;
...
$(document).ready(function() {
  ...
  paleofsettlement_baseoverlay = L.tileLayer('layerdata/paleofsettlement/{z}/{x}/{-y}.png', {
  ...
  var geojsonLayer1 = new L.GeoJSON.AJAX("geojson/jewish_communities_of_the_pale_of_settlement.geojson", {}).addTo(map);
  ...
  var overlayMaps = {
    "General": {
      "Base": paleofsettlement_baseoverlay,
    },
    "Jews in Russia": {
      "Jewish communities of the Pale of Settlement": geojsonLayer1,
    },
  };
  ...
  $("span:contains('Base')").html(' Base<br/><input id="slide" type="range" min="0" max="1" step="0.1" value="1.0" oninput="paleofsettlement_baseoverlay.setOpacity(this.value)">');
